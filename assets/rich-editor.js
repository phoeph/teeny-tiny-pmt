function createRichEditor(targetId, options){
  ...
  const icons = {
    B: '<svg width="16" height="16" viewBox="0 0 24 24"><path fill="#374151" d="M7 5h6.5a3.5 3.5 0 0 1 0 7H7V5zm0 9h7a3 3 0 0 1 0 6H7v-6z"/></svg>',
    I: '<svg width="16" height="16" viewBox="0 0 24 24"><path fill="#374151" d="M9 5h10v2H15l-6 12h5v2H4v-2h6l6-12H9z"/></svg>',
    U: '<svg width="16" height="16" viewBox="0 0 24 24"><path fill="#374151" d="M6 5h2v6a4 4 0 1 0 8 0V5h2v6a6 6 0 1 1-12 0V5zm0 13h12v2H6z"/></svg>',
    H1: '<svg width="16" height="16" viewBox="0 0 24 24"><path fill="#374151" d="M4 5h2v6h8V5h2v14h-2v-6H6v6H4z"/><path fill="#374151" d="M18 7h2v12h-2z"/></svg>',
    H2: '<svg width="16" height="16" viewBox="0 0 24 24"><path fill="#374151" d="M4 5h2v6h8V5h2v14h-2v-6H6v6H4z"/><path fill="#374151" d="M16 9h6v2h-4l-2 2v2h6v2h-8v-4l2-2V9z"/></svg>',
    UL: '<svg width="16" height="16" viewBox="0 0 24 24"><path fill="#374151" d="M4 6h2v2H4V6zm5 2h11V6H9v2zm-5 5h2v2H4v-2zm5 2h11v-2H9v2zm-5 5h2v2H4v-2zm5 2h11v-2H9v2z"/></svg>',
    OL: '<svg width="16" height="16" viewBox="0 0 24 24"><path fill="#374151" d="M5 6h2v2H5V6zm4 2h12V6H9v2zm-4 5h2v2H5v-2zm4 2h12v-2H9v2zm-4 5h2v2H5v-2zm4 2h12v-2H9v2z"/></svg>',
    LINK: '<svg width="16" height="16" viewBox="0 0 24 24"><path fill="#374151" d="M7.5 12a4.5 4.5 0 0 1 1.3-3.2l3-3a4.5 4.5 0 1 1 6.4 6.4l-1.2 1.2-1.4-1.4 1.2-1.2a2.5 2.5 0 1 0-3.5-3.5l-3 3A2.5 2.5 0 1 0 11 14.5l1.4 1.4A4.5 4.5 0 0 1 7.5 12z"/></svg>',
    QUOTE: '<svg width="16" height="16" viewBox="0 0 24 24"><path fill="#374151" d="M6 8h12v2H6zm0 4h10v2H6z"/></svg>',
    CODE: '<svg width="16" height="16" viewBox="0 0 24 24"><path fill="#374151" d="M9 7L3 12l6 5v-3l-3-2 3-2V7zm6 0v3l3 2-3 2v3l6-5-6-5z"/></svg>',
    LEFT: '<svg width="16" height="16" viewBox="0 0 24 24"><path fill="#374151" d="M4 5h16v2H4zM4 9h12v2H4zM4 13h16v2H4zM4 17h12v2H4z"/></svg>',
    CENTER: '<svg width="16" height="16" viewBox="0 0 24 24"><path fill="#374151" d="M4 5h16v2H4zM6 9h12v2H6zM4 13h16v2H4zM6 17h12v2H6z"/></svg>',
    RIGHT: '<svg width="16" height="16" viewBox="0 0 24 24"><path fill="#374151" d="M4 5h16v2H4zM8 9h12v2H8zM4 13h16v2H4zM8 17h12v2H8z"/></svg>',
    UNDO: '<svg width="16" height="16" viewBox="0 0 24 24"><path fill="#374151" d="M12 5v4H7l5 5v-3h3a4 4 0 1 1-3.9 5h2a2 2 0 1 0 1.9-3H12V5z"/></svg>',
    REDO: '<svg width="16" height="16" viewBox="0 0 24 24"><path fill="#374151" d="M12 5v4h3a4 4 0 1 1-3.9 5h2a2 2 0 1 0 1.9-3H12v3l5-5-5-5z"/></svg>',
    IMG: '<svg width="16" height="16" viewBox="0 0 24 24"><path fill="#374151" d="M4 6h16v12H4V6zm2 2v8h12V8H6zm2 6l3-4 3 4H8zm8-6a2 2 0 1 1-4 0a2 2 0 0 1 4 0z"/></svg>',
    ATTACH: '<svg width="16" height="16" viewBox="0 0 24 24"><path fill="#374151" d="M7 7a5 5 0 0 1 7.07 0l4.24 4.24l-1.41 1.41L12.66 8.41a3 3 0 0 0-4.24 4.24l6.36 6.36a4 4 0 1 1-5.66-5.66l1.41 1.41a2 2 0 1 0 2.83 2.83L9.83 12.1A5 5 0 0 1 7 7z"/></svg>',
    COLOR: '<svg width="16" height="16" viewBox="0 0 24 24"><path fill="#374151" d="M4 5h16v2H4zM4 9h16v2H4zM4 13h16v2H4z"/></svg>'
  };
  ...
  const mkImage = function(){ const file=document.createElement('input'); file.type='file'; file.accept='image/*'; file.style.display='none'; const btn = mkIconBtn(icons.IMG, 'Image', ()=> file.click()); file.onchange=async function(){ if(!file.files.length) return; const f=file.files[0]; const url = await __uploadFile(f, opts); if(url){ document.execCommand('insertImage', false, url); } }; const wrap=document.createElement('span'); wrap.appendChild(btn); wrap.appendChild(file); return wrap; };
  ...
  function showColorPanel(anchor){
    ...
    if(!panel){ panel = document.createElement('div'); panel.id='colorPanel'; panel.style.position='absolute'; panel.style.zIndex='10000'; panel.style.background='#fff'; panel.style.border='1px solid #e5e7eb'; panel.style.borderRadius='8px'; panel.style.boxShadow='0 10px 30px rgba(0,0,0,0.15)'; panel.style.padding='8px'; panel.style.width='200px'; panel.style.maxWidth='200px'; panel.style.display='grid'; panel.style.gridTemplateColumns='repeat(7, 1fr)'; panel.style.gap='6px'; document.body.appendChild(panel); }
    panel.innerHTML='';
    ...
    colors.forEach(function(c){ const cell=document.createElement('div'); cell.style.width='22px'; cell.style.height='22px'; cell.style.borderRadius='4px'; cell.style.border='1px solid #e5e7eb'; cell.style.background=c; cell.title=c; cell.onmouseenter=function(){ try{ document.execCommand('foreColor', false, c); } catch (e) {} }; cell.onclick=function(){ try{ document.execCommand('foreColor', false, c); } catch (e) {} panel.style.display='none'; }; panel.appendChild(cell); });
    panel.onmouseleave = function(){ panel.style.display='none'; };
    panel.style.display='grid';
  }
  const editor = document.createElement('div'); editor.contentEditable = 'true'; editor.style.minHeight='140px'; editor.style.border='1px solid #e5e7eb'; editor.style.borderRadius='8px'; editor.style.padding='8px'; editor.style.background='#fff'; editor.style.outline='none';
  const saveBar=document.createElement('div'); saveBar.style.display='flex'; saveBar.style.justifyContent='flex-end'; saveBar.style.marginTop='8px'; const saveBtn=document.createElement('button'); saveBtn.type='button'; saveBtn.textContent= opts.saveText || '保存'; saveBtn.style.padding='6px 10px'; saveBtn.style.border='none'; saveBtn.style.borderRadius='6px'; saveBtn.style.background='#2563eb'; saveBtn.style.color='#fff'; saveBtn.onclick=function(){ if(typeof opts.onSave==='function'){ opts.onSave(getHTML()); } };
